...
if not os.path.exists(path_newReq):
    ...
    os.mkdir(path_HW)
    os.mkdir(path_dow)
    print(f"Directory '{path_newReq}' created.")

else:
    print(f"Directory '{path_newReq}' already exists.")
...
if option_state == "inactive":
    shutil.copy(path_scripts + "Pdbs_resol_Inactive", path_newReq + "/Pdbs_resol_L")
if option_state == "active":
    shutil.copy(path_scripts + "Pdbs_resol_Active", path_newReq + "/Pdbs_resol_L")
if option_state == "intermediate":
    shutil.copy(path_scripts + "Pdbs_resol_Intermediate", path_newReq + "/Pdbs_resol_L")
else:
    shutil.copy(path_scripts + "Pdbs_resol_Inactive", path_newReq + "/Pdbs_resol_L")
# in "Pdbs_resol_Inactive" the GPCR pdbs are sorted by family and resolution
